...
public class TestBase {
	...
	static {
		...
		extent = new ExtentReports(System.getProperty("user.dir") + "/src/main/java/com/hybridFramework"
	...
	public void getBrowser(String browser) {
		if (System.getProperty("os.name").contains("browser")) {
	...
	public void loadPropertiesFile() throws IOException {
		...
		logger.info("loading config.properties");
		 ...
		 f1 = new
		 File(System.getProperty("user.dir")+"/src/main/java/com/hybridFramework/config/or.properties");
		 file = new FileInputStream(f1);
		 OR.load(file);
		 logger.info("loading or.properties");
		
		 f1 = new
		 File(System.getProperty("user.dir")+"/src/main/java/com/hybridFramework/properties/homepage.properties");
		 file = new FileInputStream(f1);
		 OR.load(file);
	...
	public WebElement waitForElementPollingInterval(WebDriver driver, long time, WebElement element) {
		WebDriverWait wait = new WebDriverWait(driver, time);
	...
	public WebElement getLocator(String locator) throws Exception {
		...
		if (locatorType.toLowerCase().equals("id"))
			...
			return driver.findElement(By.name(locatorValue));
		else if ((locatorType.toLowerCase().equals("cssselecor")) || (locatorType.toLowerCase().equals("css")))
			return driver.findElement(By.className(locatorValue));
